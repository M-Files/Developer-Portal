...
<p class="note">Dashboards are defined within the <a href="{{ site.baseurl }}/Frameworks/User-Interface-Extensibility-Framework/Structure/AppDef/">Application Definition (manifest) file</a>.  This page concentrates solely on the XML elements used to declare dashboards, and not other elements within the definition file.</p>
